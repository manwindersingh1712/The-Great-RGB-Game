...
var game=document.querySelector("#word");
var g=document.querySelectorAll(".letters");
var array=[];
var selectedWord;

var words=["Eleven","mumbai","animal","twenty","silver",
"thirty","orange","purple","family","donate","broken",
"potato","sunday","circle","center","school","breath"]
...
colorDisplay.textContent=selectedWord;


for(var i=0;i<6;i++){

	g[i].classList.add("color");
